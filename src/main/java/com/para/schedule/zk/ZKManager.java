...
import com.para.schedule.core.Version;
...
public class ZKManager {
    ...
    public void initial() throws Exception {
        ...
        if (zk.exists(this.getRootPath(), false) == null) {
            com.para.schedule.zk.ZKTools.createPath(zk, this.getRootPath(), CreateMode.PERSISTENT, acl);
            //设置版本信息
            ...
            if (value == null) {
                ...
                if (!com.para.schedule.core.Version.isCompatible(dataVersion)) {
                    throw new Exception(
                ...
                if (zk.exists(zkPath, false) != null) {
                    ...
                    if (value != null && new String(value).contains("uncode-schedule-")) {
                        throw new Exception("\"" + zkPath
                                + "\"  is already a schedule instance's root directory, its any subdirectory cannot "
                                + "as the root directory of others");
                    }
                }
            }
        }
